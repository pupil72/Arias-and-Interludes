...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private void onEnterStartedState() {
        ...
        /* Connect camera */
        if (!connectCamera(getWidth(), getHeight())) {} //this case has been dealt with already in MainActivity with camera permission request
    }
    ...
    /**
     * This method called by overriding layout method will mirror the camera
     */
