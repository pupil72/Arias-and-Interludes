...
public class Aria2 extends AppCompatActivity {
    ...
    private final int NUMBER_OF_STAVES = 19;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mp = MediaPlayer.create(getApplicationContext(), getResources().getIdentifier("chorale_solo_piano_1_loud_reamplified" +
                "", "raw", getPackageName()));
        ...
        SharedPreferences settings = getSharedPreferences("settingsAria2", MODE_PRIVATE);
        volume = settings.getFloat("volumeValue", 1.f);
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        aria1Score.setImageResource(R.drawable.chorale_solo_piano_2_300);
    ...
    public void changeSeekBar() {
        try {
            ...
            if (mp.getCurrentPosition() > nextStep-3000 && nextStep < (staffDuration*NUMBER_OF_STAVES)){ //20 is the number of leaps toward the end of the score
